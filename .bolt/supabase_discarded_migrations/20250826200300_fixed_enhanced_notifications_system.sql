-- 🚀 نظام الإشعارات المحسن والشامل - مُصحح
-- يتضمن: إشعارات إضافية، إشعارات خارجية، قوالب قابلة للتخصيص، جدولة، أرشفة

-- ========================================
-- 1. أنواع البيانات المخصصة (يجب إنشاؤها أولاً)
-- ========================================
...
-- ========================================
-- 2. جداول الإشعارات الأساسية المحسنة
-- ========================================
...
-- ========================================
-- 6. إشعارات خارجية (البريد، الرسائل، Push)
-- ========================================
...
-- ========================================
-- 7. قوالب الإشعارات القابلة للتخصيص
-- ========================================
...
CREATE INDEX IF NOT EXISTS idx_external_notifications_next_retry ON external_notifications(next_retry);
...
CREATE TRIGGER update_external_notifications_updated_at 
